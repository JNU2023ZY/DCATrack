...
cfg.MODEL.REG_TOKENS = [2,2,2,2,2,2,4,4,4,4,4,4]
# MODEL.BACKBONE
...
cfg.MODEL.DECODER.DIVIDE_NORM = False
...
cfg.TRAIN.DISTILL_LAYERS_STUDENT = [0, 1, 2, 3]
cfg.TRAIN.DISTILL_LAYERS_TEACHER = [11, 11, 11, 11]
