...
dataset_dict = dict(
    animalsot=DatasetInfo(module=pt % "animalsot", class_name="AnimalSOTDataset", kwargs=dict()),
    zoo145=DatasetInfo(module=pt % "zoo145", class_name="ZOO145Dataset", kwargs=dict()),
