...
from lib.config.mixformer2_vit_mem_online.config import update_config_from_file, cfg
...
def parameters(yaml_name: str, model=None, search_area_scale=None, online_size=None, update_interval=None):
    ...
    yaml_file = os.path.join(prj_dir, 'experiments/mixformer2_vit_mem_online/{}.yaml'.format(yaml_name))
