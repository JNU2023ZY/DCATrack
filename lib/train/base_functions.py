...
def build_dataloaders(cfg, settings, cfg_teacher=None):
    # Data transform
...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_score:
        ...
        for n, p in net.named_parameters():
            if "box_head" not in n and "mix_attn" not in n:
                p.requires_grad = False
            else:
                if is_main_process():
                    print(n)
        ...
        # param_dicts = [
        #     {"params": [p for n, p in net.named_parameters() if "backbone" not in n and "mem" not in n and "z" not in n and p.requires_grad]
        #      },
        #     {"params": [p for n, p in net.named_parameters() if "backbone" not in n and ("mem"in n or "z" in n) and p.requires_grad],
        #         "lr": cfg.TRAIN.LR*5,
        #      },
        #     {
        #         "params": [p for n, p in net.named_parameters() if "backbone" in n and "betas" not in n and "proj_mem" not in n and p.requires_grad],
        #         "lr": cfg.TRAIN.LR * cfg.TRAIN.BACKBONE_MULTIPLIER,
        #     },
        #     {
        #         "params": [p for n, p in net.named_parameters() if "backbone" in n and "proj_mem" in n and "blocks.5" in n and p.requires_grad],
        #         "lr": cfg.TRAIN.LR*5,
        #     },
        #     {
        #         "params": [p for n, p in net.named_parameters() if
        #                    "backbone" in n and "betas" in n and "blocks.5" in n and p.requires_grad],
        #         "lr": cfg.TRAIN.LR*5,
        #     },
        # ]
        param_dicts = [
        ...
        #     {
        #         "params": [p for n, p in net.named_parameters() if
        #                    "backbone" in n and "reg_tokens" in n and p.requires_grad],
        #         "lr": cfg.TRAIN.LR,
        #     },
        ]
        for n, p in net.named_parameters():
        ...
        #     p.requires_grad = True
        #     if "backbone" in n and 'pos_embed' in n:
        #         p.requires_grad = False
            # if "backbone" in n and "betas" not in n and "proj_mem" not in n:
            #     p.requires_grad = False
