...
def main():
    ...
    parser.add_argument('--script', type=str, default='mixformer2_vit_online', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='288_depth12_score', help="Name of the config file.")
    ...
    parser.add_argument('--script_teacher', type=str, default='mixformer_vit', help='teacher script name')
    parser.add_argument('--config_teacher', type=str, default='teacher_mixvit_b', help='teacher yaml configure file name')
