...
def parse_args():
    ...
    parser.add_argument('--stage1_model', type=str, default="/data_F/zhouyong/MixFormerV2-main/MixformerV2_model/MixFormer2-288-12-ep0500-teacher-l.pth.tar", help='stage1 model used to train SPM.')
